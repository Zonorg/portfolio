    ...
    <div className="w-full py-20 flex flex-col justify-start items-center max-md:py-0">
      <div className="about_content" id="about">
        ...
        <div className="about_text mt-16 flex flex-col gap-3">
          ...
          <p className="text-xl">
            Fluent in both Spanish and English (C1 level), I bring proactive, responsible, and collaborative qualities
            to every team I work with. My ability to actively listen and empathize with clients helps me deliver
            exceptional results.
          </p>
